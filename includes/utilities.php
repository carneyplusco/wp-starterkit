...
function get_archive_page_title(){
	...
	} elseif($query_obj->name === 'news-item' || $post_type === 'news-item') {
		$new_title = get_field('page_title', 'news_items_settings') ? get_field('page_title', 'news_items_settings') : get_the_archive_title();
	} else {
		if(is_home()){
